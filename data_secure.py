...
# if "failed_attemts" not in st.session_state:
...
#                 st.warnig("⚠️ User already exists.")
#             else:
...
#                     st.error("🛑 To mant failed attempts. Locked for 60 seconds")
#                     st.stop()
...
#                     stored_data[st.session_state.authenticated_user].append(encrypted)
#                     save_data(stored_data)
#                     st.success("✅ Data encrypted and save successfully!")

#                 else:
#                     st.error("All fields are requires to fill.")
...
#             else:
#                 st.write("Encryptied Data Enteries")
